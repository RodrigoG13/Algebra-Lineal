...
def reflejar(puntos, eje_x):
    """
    Realiza la transformación-reflexion a los puntos de un poligono
    :param puntos: (list) Matriz que contiene a los puntos del poligono
...
def expandir(puntos, cte_exp, eje_x):
    """
    Realiza la transformación-expansion a los puntos de un poligono
    :param puntos: (list) Matriz que contiene a los puntos del poligono
    :param cte_exp: (float) Constante de expansión que se aplicará al polígono
...
def cortar(puntos, cte_corte, eje_x):
    """
    Realiza la transformación-corte a los puntos de un poligono
    :param puntos: (list) Matriz que contiene a los puntos del poligono
    :param cte_exp: (float) Constante de corte que se aplicará al polígono
...
def rotar(puntos, angulo):
    """
    Realiza la transformación-rotación a los puntos de un poligono
    :param puntos: (list) Matriz que contiene a los puntos del poligono
    :param angulo: (float) Ángulo en que se rotará el polígono
