...
while repetir == "si":
    ...
    solucion_sistema, bandera = sistema_ecs_li(combinacion_lineal, combinacion_coef, num_elementos, num_vectores, 1)
    ...
    bandera_esp_gen = sistema_ecs_li(espacio_generador, combinacion_coef, num_elementos, num_vectores, 2)
    ...
    for lista in independencia_lineal:
        lista.append(0)
    bandera_li = sistema_ecs_li(independencia_lineal, combinacion_coef, num_elementos, num_vectores, 2)
