...
def ingresa_convierte_sistema(ecuacion_string):
    ...
    for numero in ecuacion_string:
        fila_aumentada.append(float(numero))
    return fila_aumentada, fila_aumentada[0:len(fila_aumentada)-1]
...
while k < numero_ecs:
    ...
    ecuacion_aumentada, ecuacion_coeficientes = ingresa_convierte_sistema(ecuacion)
    matrix_aumentada.append(ecuacion_aumentada)
    matrix_coeficientes.append(ecuacion_coeficientes)
    k = k+1
