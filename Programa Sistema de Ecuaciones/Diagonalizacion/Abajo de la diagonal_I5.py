...
def diagonal_uno(matriz, ecuaciones, variables):
    r = 0
    t = 0
    while r < ecuaciones:
        constante = matriz[r][r]
        while t <= variables:
            matriz[r][t] = matriz[r][t]/constante
            t = t + 1
        t = 0
        r = r + 1
    return matriz
...
num_ecs3 = 5
num_var3 = 3
print(f"La matrix dAb es {diagonaliza_abajo(matriz1, num_ecs1, num_var1)}")
# print(diagonaliza_arriba(matriz1, num_ecs1, num_var1))
# print(diagonal_uno(matriz1, num_ecs1, num_var1))