...
def transpone_matrix(matriz):
    """
    Genera la matriz para el sistema de ecuaciones
...
while repetir == "si":
    ...
    print("""Instrucciones: Ingresa una conjunto de vectores <v\u2081, v\u2082, ... , v\u2099>, y un vector
    ...
    # Crea copias de la matriz base para resolver los sistemas de ecuaciones según sea el caso
    ...
    print("\n>>>> ESPACIO GENERADOR")
    # Sí fue un espacio generador
    if bandera_esp_gen:
        print(f"\tSi es un espacio generador de ℝ{superindices[num_elementos-1]}\U0001F632!")
    
    # No fue un espacio generador
    else:
    ...
    print(f"independencia_lineal antes {independencia_lineal}")
    bandera_li = sistema_ecs(independencia_lineal, combinacion_coef, num_elementos, num_vectores, 2)
    print("\n>>>> INDEPENDENCIA LINEAL")
    print(f"independencia_lineal despues {independencia_lineal}")
    print(bandera_li)
    if bandera_li == 1:
        print("\tEl conjunto de vectores son linealmente independientes")
    
    else:
        print("\tEl conjunto de vectores son linealmente dependientes")
