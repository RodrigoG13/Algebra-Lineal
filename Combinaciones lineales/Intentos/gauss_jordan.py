...
"""
matrix_aumentada = [[6,-1,-3,3,3,0,-1], [6,2,-1,-1,-1,0,0], [6,3,2,1,2,0,-1],[6,4,4,1,1,0,0],
                    [6,5,1,1,4,0,-1], [6,6,1,-1,6,1,0]]
matrix_coeficientes = [[6,-1,-3,3,3,0], [6,2,-1,-1,-1,0], [6,3,2,1,2,0],[6,4,4,1,1,0],
                    [6,5,1,1,4,0], [6,6,1,-1,6,1]]
numero_ecs = 6
numero_incognitas = 6
sols = sistema_ecs(matrix_aumentada, matrix_coeficientes, numero_ecs)
print(sols)
"""